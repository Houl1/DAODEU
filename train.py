...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        # emb = model(feed_dict["graphs"])[0][-1].detach().cpu().numpy()
        ...
        mae_score,mse_score = get_score_t(feed_dict["graphs"][-1].detach().cpu().node_activity.numpy(),activity)
    ...
    if ap<best_epoch_ap:
        ap=best_epoch_ap
    print("Best Test AUC = {:.3f}, Best AP = {:.3f},Best MAE = {:.3f}, Best MSE = {:.3f}".format(auc_test,ap,best_epoch_mae,best_epoch_mse))
